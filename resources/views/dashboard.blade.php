...
@section('content')
    <div class="p-4 sm:p-6">
            <div class="p-4 sm:p-6">
                    ...
                    <div class="bg-white rounded-2xl shadow-lg border border-gray-100 overflow-hidden">
                        ...
                        <div id="weatherContent" class="p-4 sm:p-8">
                            ...
                            <div id="loadingState" class="flex flex-col items-center justify-center py-8 sm:py-12">
                                <div class="animate-spin rounded-full h-12 sm:h-16 w-12 sm:w-16 border-b-2 border-blue-500 mb-4"></div>
                                <p class="text-gray-600 text-sm sm:text-base text-center">Getting your location and weather data...</p>
                            </div>
                            ...
                            <div id="weatherData" class="hidden">
                                ...
                                <div class="flex flex-col sm:flex-row items-start justify-between mb-6 sm:mb-8 gap-4">
                                    <div class="flex items-start gap-4 sm:gap-6 w-full sm:w-auto">
                                        ...
                                        <div class="flex-1">
                                            ...
                                            <p id="weatherDescription" class="text-lg sm:text-xl text-gray-600 capitalize">Loading...</p>
                                ...
                                <div class="grid grid-cols-2 sm:grid-cols-2 md:grid-cols-4 gap-3 sm:gap-4">
                                    ...
                                    <div class="bg-blue-50 rounded-xl p-3 sm:p-4">
                                        ...
                                        <p class="text-xl sm:text-2xl font-bold text-gray-800"><span id="humidity">--</span>%</p>
                                    </div>
                                    ...
                                    <div class="bg-green-50 rounded-xl p-3 sm:p-4">
                                        ...
                                        <p class="text-xl sm:text-2xl font-bold text-gray-800"><span id="windSpeed">--</span> <span class="text-sm">km/h</span></p>
                                    </div>
                                    ...
                                    <div class="bg-purple-50 rounded-xl p-3 sm:p-4">
                                        ...
                                        <p class="text-xl sm:text-2xl font-bold text-gray-800"><span id="pressure">--</span> <span class="text-sm">hPa</span></p>
                                    </div>
                                    ...
                                    <div class="bg-indigo-50 rounded-xl p-3 sm:p-4">
                                        ...
                                        <p class="text-xl sm:text-2xl font-bold text-gray-800"><span id="precipitation">--</span> <span class="text-sm">mm</span></p>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="bg-white rounded-2xl shadow-lg border border-gray-100 overflow-hidden">
                        ...
                        <div id="alertsContent" class="p-4 sm:p-8">
                            ...
                            <div id="alertsLoadingState" class="flex flex-col items-center justify-center py-8 sm:py-12">
                                <div class="animate-spin rounded-full h-12 sm:h-16 w-12 sm:w-16 border-b-2 border-orange-500 mb-4"></div>
                            ...
                            <div id="alertsData" class="hidden">
                                ...
                                <div class="grid grid-cols-2 lg:grid-cols-4 gap-2 sm:gap-3 mb-4 sm:mb-6">
                                    ...
                                    <div class="bg-gradient-to-br from-yellow-50 to-yellow-100 rounded-xl p-2 sm:p-3 text-center">
                                ...
                                <div class="max-h-64 sm:max-h-96 overflow-y-auto custom-scrollbar">
                                    ...
                                    <div id="noAlertsMessage" class="hidden">
                                        <div
                                            ...
                                            <p class="text-green-600 text-xs sm:text-sm mt-2">Current weather conditions are within normal
                                                ranges</p>
                                        </div>
                                    </div>
                ...
                <!-- Stats Grid - FIXED: Mobile responsive -->
                <div class="grid grid-cols-2 md:grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6 mb-4 sm:mb-6">
                    ...
                    <div class="bg-white rounded-xl shadow-sm p-4 sm:p-6 border border-gray-100">
                        ...
                        <h3 class="text-xl sm:text-2xl font-bold text-gray-800">0</h3>
                    ...
                    <div class="bg-white rounded-xl shadow-sm p-4 sm:p-6 border border-gray-100">
                        ...
                        <h3 class="text-xl sm:text-2xl font-bold text-gray-800">0</h3>
                        <p class="text-xs sm:text-sm text-gray-600 mt-1">Favorite Spots</p>
                    </div>
                    ...
                    <div class="bg-white rounded-xl shadow-sm p-4 sm:p-6 border border-gray-100">
                        ...
                        <h3 class="text-base sm:text-2xl font-bold text-gray-800">{{ Auth::user()->created_at->diffForHumans(null, true) }}
                        </h3>
                            ...
                            <div class="grid grid-cols-1 sm:grid-cols-2 gap-3 sm:gap-4">
                                ...
                                <a href="{{ route('weather.map') }}"
                                    ...
                                    <div class="flex-1 min-w-0">
                                        <h4 class="font-semibold text-gray-800 group-hover:text-blue-700 mb-1 text-sm sm:text-base">Explore Weather
                                            Map
                                        </h4>
                                ...
                                <div
                                    ...
                                    <div class="flex-1 min-w-0">
                                        <h4 class="font-semibold text-gray-800 mb-1 flex items-center gap-2 flex-wrap text-sm sm:text-base">
                                ...
                                <a href="{{ route('profile.edit') }}"
                                    ...
                                    <div class="text-3xl sm:text-4xl flex-shrink-0">⚙️</div>
                                    <div class="flex-1 min-w-0">
                                        <h4 class="font-semibold text-gray-800 group-hover:text-blue-700 mb-1 text-sm sm:text-base">Account Settings
                                        </h4>
